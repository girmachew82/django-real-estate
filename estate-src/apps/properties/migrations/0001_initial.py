# Generated by Django 5.2.1 on 2025-05-31 12:33
            ...
            fields=[
                ...
                (
                    ...
                    django_countries.fields.CountryField(
                        default="ET", max_length=2, verbose_name="Country"
                    ),
                ),
                (
                    "city",
                    models.CharField(
                        default="Addis Ababa", max_length=188, verbose_name="City"
                    ),
                ),
                (
                    "postal_code",
                    models.CharField(
                        default=251, max_length=100, verbose_name="Postal Code"
                    ),
                ),
                (
                    "street_address",
                    models.CharField(
                        default="Haile Gebressilasie",
                        max_length=255,
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        default=0.15,
                        help_text="15% property tx charge",
                        max_digits=6,
                ...
                ("bedooms", models.IntegerField(default=1, verbose_name="Bedrooms")),
                (
                    "bathrooms",
                    models.DecimalField(
                        decimal_places=2,
                ...
                ("views", models.IntegerField(default=0, verbose_name="Total view")),
                (
                    "user",
                    models.ForeignKey(
